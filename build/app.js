        ...
        var TodoApp = (function (_super) {
            ...
            TodoApp.prototype.render = function () {
                ...
                var todoItems = shownTodos.map(function (todo) {
                    return (React.createElement(components.TodoItem, {key: todo.id, todo: todo, onToggle: _this.toggle.bind(_this, todo), onDestroy: _this.destroy.bind(_this, todo), onEdit: _this.edit.bind(_this, todo), editing: _this.state.editing === todo.id, onSave: _this.save.bind(_this, todo), onCancel: function (e) { return _this.cancel(); }}));
                });
                ...
                if (activeTodoCount || completedCount) {
                    footer = React.createElement(components.TodoFooter, {count: activeTodoCount, completedCount: completedCount, nowShowing: this.state.nowShowing, onClearCompleted: function (e) { return _this.clearCompleted(); }});
                }
                if (todos.length) {
