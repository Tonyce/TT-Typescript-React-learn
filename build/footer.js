                ...
                return (React.createElement("footer", {className: "footer"}, 
                    ...
                    React.createElement("ul", {className: "filters"}, 
                        React.createElement("li", null, 
                            React.createElement("a", {href: "#/", className: classNames({ selected: nowShowing === app.constants.ALL_TODOS })}, "All")
                        ), 
                        ' ', 
                        React.createElement("li", null, 
                            React.createElement("a", {href: "#/active", className: classNames({ selected: nowShowing === app.constants.ACTIVE_TODOS })}, "Active")
                        ), 
                        ' ', 
                        React.createElement("li", null, 
                            React.createElement("a", {href: "#/completed", className: classNames({ selected: nowShowing === app.constants.COMPLETED_TODOS })}, "Completed")
                        )), 
                    clearButton));
            };
            return TodoFooter;
